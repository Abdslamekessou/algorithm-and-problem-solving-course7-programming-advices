...
// 🧠✨ Problem: Update a client's record in the file using their Account Number.
// 📂 Each line in "Clients.txt" contains client data separated by "#//#" like:
// "A123#//#9999#//#Abdessalem#//#07900000#//#15000"
// ✏️ The program searches for the client, displays their current data,
// asks if you want to update, then lets you enter the new information.
// Finally, it saves all clients back to the file.
//
// ✅ Example Output:
//
// Please enter AccountNumber? A123
//
// The following is client record data :
// Account Number   :  A123
// Pin Code         :  9999
// Name             :  Abdessalem
// Phone            :  07900000
...
//
// Do you want to update client(Y/N)?
// Y
// Enter Pin Code ? 5555
// Name ? Abdessalem Kessouri
// Phone ? 07911111
...
bool UpdateClientByAccountNumber(string AccountNumber, vector <stClient>& vClients) {
    ...
    if (FindClientByAccountNumber(AccountNumber, vClients, Client)) {
        ...
        cout << "\nDo you want to update client(Y/N)? " << endl;
        cin >> Answer;
